...
ROOT_URLCONF = 'social_marketing.urls'
...
WSGI_APPLICATION = 'social_marketing.wsgi.application'
...
# Celery Configuration for SQLite setup
...
# Social Media API Credentials (from .env)
SOCIALACCOUNT_PROVIDERS = {
    ...
    'instagram': {
        'APP': {
            'client_id': env('FACEBOOK_APP_ID', default=''), # Unified with Facebook usually
            'secret': env('FACEBOOK_APP_SECRET', default=''),
            'key': ''
        }
    },
    'google': { # For YouTube
        'APP': {
            'client_id': env('YOUTUBE_CLIENT_ID', default=''),
            'secret': env('YOUTUBE_CLIENT_SECRET', default=''),
            'key': ''
        }
    }
}
